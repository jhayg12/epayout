...
<html class="no-js">
    ...
    <head>
        ...
        <link href="<?php echo base_url(); ?>third_party/vendors/easypiechart/jquery.easy-pie-chart.css" rel="stylesheet" media="screen">
    ...
    <body>
            ...
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Mill Marks</div>
                    ...
                    <div class="row-fluid section">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Inventory Items <small>Monthly growth</small></div>
                                <div class="pull-right"><span class="badge badge-warning">View More</span>
                    ...
                    <div class="row-fluid section">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Rejections</div>
                                <div class="pull-right"><span class="badge badge-warning">View More</span>
                            ...
                            <div class="block-content collapse in">
                                <div class="span6 chart">
                                    <h5>Quarantine Items</h5>
                                    <div id="hero-bar" style="height: 250px;"></div>
                                </div>
                                <div class="span5 chart">
                                    <h5>Month Rejections</h5>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Monthly Sales</div>
                                <div class="pull-right"><span class="badge badge-warning">View More</span>
        ...
        <!--/.fluid-container-->
        <link rel="stylesheet" href="<?php echo base_url(); ?>third_party/vendors/morris/morris.css">


        <script src="<?php echo base_url(); ?>third_party/vendors/jquery-1.9.1.min.js"></script>
        <script src="<?php echo base_url(); ?>third_party/vendors/jquery.knob.js"></script>
        <script src="<?php echo base_url(); ?>third_party/vendors/raphael-min.js"></script>
        <script src="<?php echo base_url(); ?>third_party/vendors/morris/morris.min.js"></script>

        <script src="<?php echo base_url(); ?>third_party/bootstrap/js/bootstrap.min.js"></script>
        <script src="<?php echo base_url(); ?>third_party/vendors/flot/jquery.flot.js"></script>
        <script src="<?php echo base_url(); ?>third_party/vendors/flot/jquery.flot.categories.js"></script>
        <script src="<?php echo base_url(); ?>third_party/vendors/flot/jquery.flot.pie.js"></script>
        <script src="<?php echo base_url(); ?>third_party/vendors/flot/jquery.flot.time.js"></script>
        <script src="<?php echo base_url(); ?>third_party/vendors/flot/jquery.flot.stack.js"></script>
        <script src="<?php echo base_url(); ?>third_party/vendors/flot/jquery.flot.resize.js"></script>
        ...
        Morris.Donut({
            element: 'hero-donut',
            data: [
                {label: 'Hisumco', value: 25 },
                {label: 'Biscom', value: 40 },
                {label: 'Lopez', value: 25 },
                {label: 'CADP', value: 10 }
            ],
        ...
        // Morris Line Chart
        var tax_data = [
            {"period": "2013-04", "Item": 2407, "Qty": 660},
            {"period": "2013-03", "Item": 3351, "Qty": 729},
            {"period": "2013-02", "Item": 2469, "Qty": 1318},
            {"period": "2013-01", "Item": 2246, "Qty": 461},
            {"period": "2012-12", "Item": 3171, "Qty": 1676},
            {"period": "2012-11", "Item": 2155, "Qty": 681},
            {"period": "2012-10", "Item": 1226, "Qty": 620},
            {"period": "2012-09", "Item": 2245, "Qty": 500}
        ];
        Morris.Line({
            element: 'hero-graph',
            data: tax_data,
        ...
        Morris.Area({
            element: 'hero-area',
            data: [
                {period: '2015 Q1', CADP: 2666, VMC: null, Lopez: 2647},
                {period: '2015 Q2', CADP: 2778, VMC: 2294, Lopez: 2441},
                {period: '2015 Q3', CADP: 4912, VMC: 1969, Lopez: 2501},
                {period: '2015 Q4', CADP: 3767, VMC: 3597, Lopez: 5689},
                {period: '2016 Q1', CADP: 6810, VMC: 1914, Lopez: 2293},
                {period: '2016 Q2', CADP: 5670, VMC: 4293, Lopez: 1881},
                {period: '2016 Q3', CADP: 4820, VMC: 3795, Lopez: 1588},
                {period: '2016 Q4', CADP: 15073, VMC: 5967, Lopez: 5175},
                {period: '2017 Q1', CADP: 10687, VMC: 4460, Lopez: 2028},
                {period: '2017 Q2', CADP: 8432, VMC: 5713, Lopez: 1791}
            ],
            xkey: 'period',
            ykeys: ['CADP', 'VMC', 'Lopez'],
            labels: ['CADP', 'VMC', 'Lopez'],
            lineWidth: 2,
            hideHover: 'auto',
