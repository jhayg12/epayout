...
<head>
  ...
  <style type="text/css">
    ...
    div#bene_name_select_chosen, div#bankbname_select_chosen {
      display: none;
    }
...
<body>
            ...
            <div class="block-content collapse in">
              <div class="span12">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="currency" value="<?php echo $idtls->CurrencyDoc; ?>" class="span6 m-wrap"
                      readonly />
                  </div>
                </div>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <?php echo form_dropdown('bene_name', $bene_name_list, strtoupper($idtls->VendorCode), 'class="bene_name span6 m-wrap", id="bene_name_select" required readonly' ); ?>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <?php echo form_dropdown('bene_bank_name', $bank_list, $this->input->post('bene_bank_name'), 'class="bene_bank_name span6 m-wrap", id="bankbname_select" required '); ?>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    ...
                    <?php 
                                        ...
                                        if (trim($idtls->Address2) != NULL) {
                                          $BeneAddr .= $idtls->Address2 .' ';
                                        }

                                        if (trim($idtls->Address3) != NULL) {
                                          $BeneAddr .= $idtls->Address3 .' ';
                                        }

                                        if (trim($idtls->Street) != NULL) {
                                          $BeneAddr .= $idtls->Street .' ';
                                        }

                                        if (trim($idtls->Block) != NULL) {
                                          $BeneAddr .= $idtls->Block .' ';
                                        }

                                        if (trim($idtls->City) != NULL) {
                                          $BeneAddr .= $idtls->City .' ';
                                        }

                                        if (trim($BeneAddr) === NULL) {
                                          $BeneAddr = "NO ADDRESS AVAILABLE";
                                        }
                                      ?>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    ...
                    <input type="text" name="net_amount" id="net_amount" value="<?php echo number_format($amount, 2) ?>"
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="debt_acctno" data-required="1" value="013030000702" class="span6 m-wrap"
                      required />
                  </div>
                </div>
  ...
  <script>
    $(function () {
      ...
      $("#bene_name_select").hide();
      $("#bankbname_select").hide();
