                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                ...
                                <div class="muted pull-right"><a href="<?php echo site_url('main/settings_login'); ?>"><i class="icon-cog"></i></a></div>
                            ...
                            <div class="block-content collapse in">
                                ...
                                <?php echo form_open(current_url(), 'class="form-horizontal"') ?>
                                  ...
                                  <div class="row-fluid">
                                      <div class="span12">
                                        <div class="form-actions">
                                          <button type="submit" class="btn btn-success"><i class="icon-ok icon-white"></i> Get</button>
                                  ...
                                  <div class="row-fluid">
                                    <div class="span12">
                                      <a href="<?php echo site_url('main/view_logs'); ?>" class="btn btn-primary pull-right" role="button">View Logs >></a>
                                    </div>
                                  </div>
