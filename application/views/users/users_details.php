...
<html>
    ...
    <head>
        ...
        <style type="text/css">
            body, html, table, span, select, input, textarea{
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
                    ...
                    <div class="navbar">
                        <div class="navbar-inner">
                            <ul class="breadcrumb">
                                ...
                                <li class="active">Users Management - Details</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <?php if(isset($usr_dtls)): foreach($usr_dtls as $dtls): ?>

                     <div class="row-fluid">
                        <!-- block -->
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">User Management - Details</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">

                            <legend><b><?php echo $dtls->memb__username; ?></b></legend>
                            ...
                            <div class="span12">
                                    ...
                                    <div class="control-group">
                                      ...
                                      <div class="controls">
                                        <input type="text" name="user_id" value="<?php echo $dtls->memb__id; ?>" data-required="1" class="span4 m-wrap" disabled/>
                                      </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">Email Address <span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text" name="eadd" value="<?php echo $dtls->memb__email; ?>" data-required="1" class="span4 m-wrap"  required/>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                      <label class="control-label" for="dept_select">Department <span class="required">*</span></label>
                                      <div class="controls">
                                        <?php echo form_dropdown('dept', $dept_list, $dtls->memb__dept, 'class="chzn-select span6 m-wrap", id="dept_select"'); ?>
                                      </div>
                                    </div>
                                    <div class="control-group">
                                      <label class="control-label" for="memb_select">Members Of <span class="required">*</span></label>
                                      <div class="controls">
                                        <?php echo form_dropdown('usr_type', $usr_type, $dtls->memb__type, 'class="chzn-select span6 m-wrap", id="memb_select"'); ?>
                                      </div>
                                    </div>
                            ...
                            <legend>Access Modules</legend>
                                    ...
                                    <div class="span-12">
                                            ...
                                            <?php $sales_acc = ""; ?>
                                            <?php if ($acc_sales): foreach ($acc_sales as $asales): ?>
                                                <?php $sales_acc = $asales->accessname; ?>
                                            <?php endforeach; ?>
                                            <?php else: ?>
                                                <?php $sales_acc = 2; ?>
                                            <?php endif; ?>
                                            ...
                                            <div class="control-group">
                                              ...
                                              <div class="controls">
                                                <?php echo form_dropdown('sales_acc', $access_type, $sales_acc, 'class="chzn-select span6 m-wrap", id="sa_acc_select"'); ?>
                                              </div>
                                            </div>

                                            <?php $trading_acc = ""; ?>
                                            <?php if ($acc_tdg): foreach ($acc_tdg as $atdg): ?>
                                                <?php $trading_acc = $atdg->accessname; ?>
                                            <?php endforeach; ?>
                                            <?php else: ?>
                                                <?php $trading_acc = 2; ?>
                                            <?php endif; ?>
                                            ...
                                            <div class="control-group">
                                              ...
                                              <div class="controls">
                                                <?php echo form_dropdown('trading_acc', $access_type, $trading_acc, 'class="chzn-select span6 m-wrap", id="tr_acc_select"'); ?>
                                              </div>
                                            </div>

                                            <?php $tre_acc = ""; ?>
                                            <?php if ($acc_tre): foreach ($acc_tre as $atre): ?>
                                                <?php $tre_acc = $atre->accessname; ?>
                                            <?php endforeach; ?>
                                            <?php else: ?>
                                                <?php $tre_acc = 2; ?>
                                            <?php endif; ?>
                                            ...
                                            <div class="control-group">
                                              ...
                                              <div class="controls">
                                                <?php echo form_dropdown('tre_acc', $access_type, $tre_acc, 'class="chzn-select span6 m-wrap", id="tre_acc_select"'); ?>
                                              </div>
                                            </div>

                                            <?php $bnc_acc = ""; ?>
                                            <?php if ($acc_bnc): foreach ($acc_bnc as $abnc): ?>
                                                <?php $bnc_acc = $abnc->accessname; ?>
                                            <?php endforeach; ?>
                                            <?php else: ?>
                                                <?php $bnc_acc = 2; ?>
                                            <?php endif; ?>
                                            ...
                                            <div class="control-group">
                                              ...
                                              <div class="controls">
                                                <?php echo form_dropdown('bnc_acc', $access_type, $bnc_acc, 'class="chzn-select span6 m-wrap", id="bnc_acc_select"'); ?>
                                              </div>
                                            </div>

                                            <?php $act_acc = ""; ?>
                                            <?php if ($acc_acct): foreach ($acc_acct as $aact): ?>
                                                <?php $act_acc = $aact->accessname; ?>
                                            <?php endforeach; ?>
                                            <?php else: ?>
                                                <?php $act_acc = 2; ?>
                                            <?php endif; ?>
                                            ...
                                            <div class="control-group">
                                              ...
                                              <div class="controls">
                                                <?php echo form_dropdown('act_acc', $access_type, $act_acc, 'class="chzn-select span6 m-wrap", id="act_acc_select"'); ?>
                                              </div>
                                            </div>

                                            <?php $loans_acc = ""; ?>
                                            <?php if ($acc_loans): foreach ($acc_loans as $aloans): ?>
                                                <?php $loans_acc = $aloans->accessname; ?>
                                            <?php endforeach; ?>
                                            <?php else: ?>
                                                <?php $loans_acc = 2; ?>
                                            <?php endif; ?>
                                            ...
                                            <div class="control-group">
                                              ...
                                              <div class="controls">
                                                <?php echo form_dropdown('loans_acc', $access_type, $loans_acc, 'class="chzn-select span6 m-wrap", id="loans_acc_select"'); ?>
                                              </div>
                                            </div>

                                            <?php $log_acc = ""; ?>
                                            <?php if ($acc_log): foreach ($acc_log as $alog): ?>
                                                <?php $log_acc = $alog->accessname; ?>
                                            <?php endforeach; ?>
                                            <?php else: ?>
                                                <?php $log_acc = 2; ?>
                                            <?php endif; ?>
                                            ...
                                            <div class="control-group">
                                              ...
                                              <div class="controls">
                                                <?php echo form_dropdown('log_acc', $access_type, $log_acc, 'class="chzn-select span6 m-wrap", id="log_acc_select"'); ?>
                                              </div>
                                            </div>
                                    </div>
                                ...
                                <legend>User Status</legend>
                                    ...
                                    <div class="span12">
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">Last Session </label>
                                                <div class="controls">
                                                    <?php if ($usr_last_Login): foreach ($usr_last_Login as $ull):  ?>
                                                    <input type="text" name="eadd" value="<?php echo $ull->date; echo " "; echo $ull->time; ?>" data-required="1" class="span4 m-wrap"  disabled/>
                                                    <?php endforeach; ?>
                                                    <?php else: ?>
                                            ...
                                            <div class="control-group">
                                              ...
                                              <div class="controls">
                                                ...
                                                <?php echo form_dropdown('usr_stats', $stats_list, $dtls->memb__status, 'class="chzn-select span6 m-wrap", id="stats_select"'); ?>
                                              </div>
                                            </div>    
                                    </div>
                                              ...
                                              <a href="<?php echo site_url('main/user_mgmt'); ?>" role="button" class="btn btn-default btn-sm pull-right"> Back</a>
                                                ...
                                                <div id="update_modal" class="modal hide">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>Record(s) of <b><?php echo $dtls->memb__username; ?></b> will be udpated.</p>
                                                    </div>
                                                ...
                                                <!-- <div id="delete_modal" class="modal hide">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>Record(s) of <b><?php echo $dtls->memb__username; ?></b> will be deleted.</p>
                                                    </div>
                                                    <div class="modal-footer">
