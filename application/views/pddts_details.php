...
<html>
    ...
    <head>
        ...
        <style type="text/css">
            ...
            #bene_acct, #bene_addr, #net_amount, #bene_name {
              font-weight: bold;
            }
                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                ...
                                <?php echo form_open("main/validate_pddts", 'class="form-horizontal"') ?>
                                  ...
                                  <!-- <div class="control-group">
                                    ...
                                    <div class="controls">
                                      ...
                                      <input type="text" name="bene_name_orig" id="bene_name_orig" class="span1 m-wrap" value="<?php echo $idtls->BeneficiaryAccountName; ?>">
